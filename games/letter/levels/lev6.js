...
letters.forEach(item => {
    item.onclick = () => {
        if(item.innerText == '1'){
            ...
            localStorage.setItem('letLev6', rainting);
...
nextLevel.onclick = () => {
    ...
    effect.ontransitionend = () => location.href = 'lev7.html';
}
backLevel.onclick = () =>{
    effect.style.clipPath = 'circle(100%)';
    effect.ontransitionend = () => location.href = 'lev5.html';
};