...
letters.forEach(item => {
    item.onclick = () => {
        if(item.innerText == 'V'){
            ...
            localStorage.setItem('letLev5', rainting);
...
nextLevel.onclick = () => {
    ...
    effect.ontransitionend = () => location.href = 'lev6.html';
}
backLevel.onclick = () =>{
    effect.style.clipPath = 'circle(100%)';
    effect.ontransitionend = () => location.href = 'lev4.html';
};